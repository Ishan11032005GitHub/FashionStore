function signIn(){
    document.getElementById("BUTTONFORPURCHASE").style.visibility="hidden";
...
function collectInfo(){
    ...
    document.getElementById("SIGNIN").style.height="40vh";
    ...
    document.getElementById("BUTTONFORPURCHASE").style.visibility="hidden";
    document.getElementById("BUTTONFORPURCHASE1").style.visibility="visible";
    isSignedin=1;
}
function signOut(){
    isSignedin=0;
...
function exitSignIn(){
    ...
    document.getElementById("BUTTONFORPURCHASE").style.visibility="visible";
    setTimeout(function(){
        window.location.reload();
     }, 5000);
}
